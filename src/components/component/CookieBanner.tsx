...
const CookieBanner = () => {
  ...
  const [cookies, setCookie] = useLocalStorage("acceptCookies", false);
  ...
  if (!isMounted) {
    return null; // Ensures the component doesn't render on the server
  }
        ...
        <div className="flex gap-x-5">
          ...
          <div className="grow">
            ...
            <p className="mt-2 text-sm text-gray-600 dark:text-neutral-400">
              By clicking &apos;Allow&apos;, you agree to use of all cookies.
              Visit our{" "}
              <a
